...
// It should be compiled without the instrumentation pass and will hopefully still work.
#include <cstddef>
#include "internal.h"
...
int add(int a, int b) {
    return _Z3addii__fn__(a,b);
}

__attribute__((constructor))
void _Z3addii__init__() {
    TypeDesc* i32_type_desc = Internal::get_i32_type();
    TypeDesc* _Z3addii__fntypedesc__ = Internal::get_function_type(i32_type_desc, 2, i32_type_desc, i32_type_desc);
    _Z3addii__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z3addii__name__, 
        _Z3addii__fntypedesc__,
        reinterpret_cast<Fn*>(&_Z3addii__fn__),
        reinterpret_cast<Fn>(_Z3addii__original__), 
        reinterpret_cast<Fn>(_Z3addii__extended__), 
        _Z3addii__reflect__
    );    
}
...
__attribute__((constructor))
void _Z11intTypeTestbcsi__init__() {
    ...
    TypeDesc* _Z11intTypeTestbcsi__fntypedesc__ = Internal::get_function_type(i64_type_desc, 4, i1_type_desc, i8_type_desc, i16_type_desc, i32_type_desc);
    _Z11intTypeTestbcsi__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z11intTypeTestbcsi__name__, 
        _Z11intTypeTestbcsi__fntypedesc__,
        reinterpret_cast<Fn*>(&_Z11intTypeTestbcsi__fn__),
        reinterpret_cast<Fn>(_Z11intTypeTestbcsi__original__), 
        reinterpret_cast<Fn>(_Z11intTypeTestbcsi__extended__), 
       _Z11intTypeTestbcsi__reflect__
    );    
}
...
double floatTypeTest(float f, double d) {
    return _Z13floatTypeTestfd__fn__(f,d);
}

__attribute__((constructor))
void _Z13floatTypeTestfd__init__() {
    TypeDesc* float_type_desc = Internal::get_float_type();
    TypeDesc* double_type_desc = Internal::get_double_type();
    TypeDesc* _Z13floatTypeTestfd__fntypedesc__ = Internal::get_function_type(double_type_desc, 2, float_type_desc, double_type_desc);
    _Z13floatTypeTestfd__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z13floatTypeTestfd__name__, 
        _Z13floatTypeTestfd__fntypedesc__,
        reinterpret_cast<Fn*>(&_Z13floatTypeTestfd__fn__), 
        reinterpret_cast<Fn>(_Z13floatTypeTestfd__original__), 
        reinterpret_cast<Fn>(_Z13floatTypeTestfd__extended__), 
       _Z13floatTypeTestfd__reflect__
    );    
}
...
int* pointerTypeTest(int* ip, double* dp) {
    return _Z15pointerTypeTestPiPd__fn__(ip,dp);
}

__attribute__((constructor))
void _Z15pointerTypeTestPiPd__init__() {
    TypeDesc* i32_type_desc = Internal::get_i32_type();
    ...
    TypeDesc* _Z15pointerTypeTestPiPd__fntypedesc__ = Internal::get_function_type(int_ptr_type_desc, 2, int_ptr_type_desc, double_ptr_type_desc);
    _Z15pointerTypeTestPiPd__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z15pointerTypeTestPiPd__name__, 
        _Z15pointerTypeTestPiPd__fntypedesc__,
        reinterpret_cast<Fn*>(&_Z15pointerTypeTestPiPd__fn__), 
...
void voidTypeTest(int* ip) {
    _Z12voidTypeTestPi__fn__(ip);
}

__attribute__((constructor))
void _Z12voidTypeTestPi__init__() {
    TypeDesc* i32_type_desc = Internal::get_i32_type();
    TypeDesc* int_ptr_type_desc = Internal::get_ptr_type(i32_type_desc);
    TypeDesc* void_type_desc = Internal::get_void_type();
    TypeDesc* _Z12voidTypeTestPi__fntypedesc__ = Internal::get_function_type(void_type_desc, 1, int_ptr_type_desc);
    _Z12voidTypeTestPi__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z12voidTypeTestPi__name__, 
        _Z12voidTypeTestPi__fntypedesc__,
        reinterpret_cast<Fn*>(&_Z12voidTypeTestPi__fn__),
        reinterpret_cast<Fn>(_Z12voidTypeTestPi__original__), 
        reinterpret_cast<Fn>(_Z12voidTypeTestPi__extended__), 
       _Z12voidTypeTestPi__reflect__
    );
} 
...
Result structTypeTest(int a, int b) {
    return _Z14structTypeTestii__fn__(a, b);
}

__attribute__((constructor))
void _Z14structTypeTestii__init__() {
    TypeDesc* i32_type_desc = Internal::get_i32_type();
    TypeDesc* i64_type_desc = Internal::get_i64_type();
    TypeDesc* double_type_desc = Internal::get_double_type();   
    TypeDesc* struct_type_desc = Internal::get_anon_struct_type(2, i64_type_desc, double_type_desc);
    TypeDesc* _Z14structTypeTestii__fntypedesc__ = Internal::get_function_type(struct_type_desc, 2, i32_type_desc, i32_type_desc);
    _Z14structTypeTestii__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z14structTypeTestii__name__, 
        _Z14structTypeTestii__fntypedesc__,
        reinterpret_cast<Fn*>(&_Z14structTypeTestii__fn__), 
        reinterpret_cast<Fn>(_Z14structTypeTestii__original__), 
        reinterpret_cast<Fn>(_Z14structTypeTestii__extended__), 
        _Z14structTypeTestii__reflect__
    );    
}
...
static Node* (*_Z19namedStructTypeTestP4Nodei__fn__)(Node*, int) = _Z19namedStructTypeTestP4Nodei__original__;
...
__attribute__((constructor))
void _Z19namedStructTypeTestP4Nodei__init__() {
    TypeDesc* struct_type_desc = Internal::get_forward_struct_type(augmentum__module_name__, augmentum__node_struct_type_name__);
    TypeDesc* i32_type_desc = Internal::get_i32_type();    
    ...
    TypeDesc* _Z19namedStructTypeTestP4Nodei__fntypedesc__ = Internal::get_function_type(struct_ptr_type_desc, 2, struct_ptr_type_desc, i32_type_desc);
    _Z19namedStructTypeTestP4Nodei__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z19namedStructTypeTestP4Nodei__name__, 
...
static int (*_Z15unknownTypeTest9arrStruct__fn__)(arrStruct) = _Z15unknownTypeTest9arrStruct__original__;
...
int unknownTypeTest(arrStruct a) {
    return _Z15unknownTypeTest9arrStruct__fn__(a);
}

__attribute__((constructor))
void _Z15unknownTypeTest9arrStruct__init__() {
    TypeDesc* unknown_type_desc = Internal::get_unknown_type(augmentum__module_name__,augmentum__unknown_type_signature__);
    TypeDesc* i32_type_desc = Internal::get_i32_type();
    TypeDesc* struct_type_desc = Internal::get_anon_struct_type(2, unknown_type_desc, i32_type_desc);
    TypeDesc* _Z15unknownTypeTest9arrStruct__fntypedesc__ = Internal::get_function_type(i32_type_desc, 1, unknown_type_desc);
    _Z15unknownTypeTest9arrStruct__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z15unknownTypeTest9arrStruct__name__, 
...
static void _Z9byValTestiiiiii10SomeStruct__original__(int p0, int p1, int p2, int p3, int p4, int p5, SomeStruct s);
...
static void (*_Z9byValTestiiiiii10SomeStruct__fn__)(int, int, int, int, int, int, SomeStruct) = _Z9byValTestiiiiii10SomeStruct__original__;
...
static void _Z9byValTestiiiiii10SomeStruct__extended__(int p0, int p1, int p2, int p3, int p4, int p5, SomeStruct s) {
...
__attribute__((constructor))
void _Z9byValTestiiiiii10SomeStruct__init__() {
    TypeDesc* i32_type_desc = Internal::get_i32_type();
    TypeDesc* i8_type_desc = Internal::get_i8_type();
    TypeDesc* i8_ptr_type_desc = Internal::get_ptr_type(i8_type_desc);
    TypeDesc* i64_type_desc = Internal::get_i64_type();
    TypeDesc* void_type_desc = Internal::get_void_type();
    TypeDesc* struct_type_desc = Internal::get_forward_struct_type(augmentum__module_name__, augmentum__someStruct_struct_type_name__);
    TypeDesc* struct_ptr_type_desc = Internal::get_ptr_type(struct_type_desc);
    Internal::set_struct_elem_types(struct_type_desc, 2, i8_ptr_type_desc, i64_type_desc);
    TypeDesc* _Z9byValTestiiiiii10SomeStruct__fntypedesc__ = Internal::get_function_type(
        void_type_desc, 7, i32_type_desc, i32_type_desc, i32_type_desc, 
    ...
    _Z9byValTestiiiiii10SomeStruct__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z9byValTestiiiiii10SomeStruct__name__, 
...
static void (*_Z13arrayTypeTestP9Container__fn__)(Container*) = _Z13arrayTypeTestP9Container__original__;
...
void arrayTypeTest(Container* c) {
    _Z13arrayTypeTestP9Container__fn__(c);
}

__attribute__((constructor))
void _Z13arrayTypeTestP9Container__init__() {
    TypeDesc* struct_type_desc = Internal::get_forward_struct_type(augmentum__module_name__, augmentum__container_struct_type_name__);
    TypeDesc* i32_type_desc = Internal::get_i32_type();    
    ...
    TypeDesc* void_type_desc = Internal::get_void_type();
    TypeDesc* _Z13arrayTypeTestP9Container__fntypedesc__ = Internal::get_function_type(void_type_desc, 1, struct_ptr_type_desc);
    _Z13arrayTypeTestP9Container__extension_point__ = Internal::create_extension_point(
        augmentum__module_name__,
        _Z13arrayTypeTestP9Container__name__, 
