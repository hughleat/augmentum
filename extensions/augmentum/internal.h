...
// It is used only because it is a slightly simpler API to manually construct in LLVM.
...
namespace augmentum {
    ...
    struct Internal {
        ...
        static FnExtensionPoint* create_extension_point(const char* module, const char* name, TypeDesc* type, Fn* fn, Fn original, Fn extended, ReflectFn reflect);
