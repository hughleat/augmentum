...
namespace augmentum {
    void Internal::debug_print(const char* message) {
        std::cout << message;
    }

    void Internal::debug_print_addr(const void* addr) {
        std::cout << addr;
    }
    ...
    TypeDesc* Internal::get_void_type() {
        return VoidTypeDesc::get();
    }

    TypeDesc* Internal::get_i1_type() {
        return IntTypeDesc::get_i1();
    }
    TypeDesc* Internal::get_i8_type() {
        return IntTypeDesc::get_i8();
    }
    TypeDesc* Internal::get_i16_type() {
        return IntTypeDesc::get_i16();
    }
    TypeDesc* Internal::get_i32_type() {
        return IntTypeDesc::get_i32();
    }
    TypeDesc* Internal::get_i64_type() {
        return IntTypeDesc::get_i64();
    }

    TypeDesc* Internal::get_float_type() {
        return FloatTypeDesc::get_float();
    }
    TypeDesc* Internal::get_double_type() {
        return FloatTypeDesc::get_double();
    }

    TypeDesc* Internal::get_ptr_type(TypeDesc* elem_type) {
        return PointerTypeDesc::get(elem_type);
    }
    ...
    FnExtensionPoint* Internal::create_extension_point(const char* module, const char* name, TypeDesc* type, Fn* fn, Fn original, Fn extended, ReflectFn reflect) {
        FnExtensionPoint* pt = new FnExtensionPoint(module, name, reinterpret_cast<FnTypeDesc*>(type), fn, original, extended, reflect);
