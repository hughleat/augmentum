...
namespace augmentum {
    namespace llvmpass {
        ...
        */
        ...
        /**
         * Command line option to specify an output directory for instrumentation statistics. 
         */
        ...
        /**
         * Command line option to specify if only statistics should be collected and no instrumentation performed. 
         */
        ...
        /**
         * Command line option to specify an output folder for LLVM-IR code of transformed modules. 
         */
        static cl::opt<std::string> EmitIRDirectory(
            "emit-transformed-ir",
            cl::desc("Specify a folder where LLVM IR code of transformed modules will be stored."),
            cl::init("")
        );

        /**
         * Command line option to specify a file where target functions that should be instrumented can be found. 
         */
        static cl::opt<std::string> TargetFunctions(
            "target-functions",
            cl::desc("Specify a csv file where target functions are listed that should "
                     " be instrumented.")
        );
        ...
        * AugmentumModule first sets up per module things and decides which functions to
        * instrument. Then it gets this class to do the work per function.
        */
        struct AugmentumFunction {
            ...
            */
            bool transform() {
                if (can_be_instrumented(function) == CAN_INSTRUMENT && 
                    should_instrument.function(function)) {
        ...
        private:
            ...
            * Some symbol names
            */
            static constexpr const char* symbol_Internal__get_unknown_type = "_ZN9augmentum8Internal16get_unknown_typeEPKcS2_";
            static constexpr const char* symbol_Internal__get_void_type = "_ZN9augmentum8Internal13get_void_typeEv";
            static constexpr const char* symbol_Internal__get_i1_type = "_ZN9augmentum8Internal11get_i1_typeEv";
            static constexpr const char* symbol_Internal__get_i8_type = "_ZN9augmentum8Internal11get_i8_typeEv";
            static constexpr const char* symbol_Internal__get_i16_type = "_ZN9augmentum8Internal12get_i16_typeEv";
            static constexpr const char* symbol_Internal__get_i32_type = "_ZN9augmentum8Internal12get_i32_typeEv";
            static constexpr const char* symbol_Internal__get_i64_type = "_ZN9augmentum8Internal12get_i64_typeEv";
            static constexpr const char* symbol_Internal__get_float_type = "_ZN9augmentum8Internal14get_float_typeEv";
            static constexpr const char* symbol_Internal__get_double_type = "_ZN9augmentum8Internal15get_double_typeEv";
            static constexpr const char* symbol_Internal__get_ptr_type = "_ZN9augmentum8Internal12get_ptr_typeEPNS_8TypeDescE";
            static constexpr const char* symbol_Internal__get_array_type = "_ZN9augmentum8Internal14get_array_typeEPNS_8TypeDescEm";
            static constexpr const char* symbol_Internal__get_anon_struct_type = "_ZN9augmentum8Internal20get_anon_struct_typeEmz";          
            static constexpr const char* symbol_Internal__get_forward_struct_type = "_ZN9augmentum8Internal23get_forward_struct_typeEPKcS2_";
            static constexpr const char* symbol_Internal__set_struct_elem_types = "_ZN9augmentum8Internal21set_struct_elem_typesEPNS_8TypeDescEmz";            
            static constexpr const char* symbol_Internal__get_function_type = "_ZN9augmentum8Internal17get_function_typeEPNS_8TypeDescEmz";
            static constexpr const char* symbol_Internal__create_extension_point = "_ZN9augmentum8Internal22create_extension_pointEPKcS2_PNS_8TypeDescEPPFvvES6_S6_PFvPvPS8_E";
            static constexpr const char* symbol_Internal__eval = "_ZN9augmentum8Internal4evalEPNS_16FnExtensionPointEPvPS3_";
            
            static constexpr const char* symbol_Internal__debug_print = "_ZN9augmentum8Internal11debug_printEPKc";
            static constexpr const char* symbol_Internal__debug_print_addr = "_ZN9augmentum8Internal16debug_print_addrEPKv";

            static constexpr const char* symbol_struct_augmentum__extension_point = "struct.augmentum::FnExtensionPoint";
            ...
            void gen_debug_print_instructions(IRBuilder<>& builder, StringRef message) {
                ...
                if (debug_msg_global == nullptr) {
                    debug_msg_global = new GlobalVariable(module, debug_msg_data->getType(), true, GlobalValue::PrivateLinkage, debug_msg_data, debug_msg_global_name);
                }
                auto zero = ConstantInt::getSigned(Type::getInt32Ty(ctx), 0);
                auto debug_msg_access = ConstantExpr::getInBoundsGetElementPtr(debug_msg_data->getType(), debug_msg_global, ArrayRef<Constant*>({zero, zero}));

                auto debug_print = module.getOrInsertFunction(symbol_Internal__debug_print, void_type, Type::getInt8PtrTy(ctx)); 
                auto debug_print_call = builder.CreateCall(debug_print.getFunctionType(), debug_print.getCallee(), {debug_msg_access});
            ...
            void gen_debug_print_addr_instructions(IRBuilder<>& builder, Value* ptr) {
                ...
                FunctionCallee debug_print_addr = module.getOrInsertFunction(symbol_Internal__debug_print_addr, void_type, void_ptr_type); 
                CallInst* debug_print_addr_call = builder.CreateCall(debug_print_addr.getFunctionType(), debug_print_addr.getCallee(), {ptr_void});
            ...
            */
            ...
            /**
             * Add call attributes to a call of the fn pointer or the original if required.
             */
            ...
            /**
             * Add function attributes to a call of the fn pointer or the original if required.
             */
            ...
            */
            void declare_globals() {
                ...
                auto extension_point_ptr_type = get_type_by_name_or_create(symbol_struct_augmentum__extension_point)->getPointerTo();
                extension_point_ptr = dyn_cast<GlobalVariable>(module.getOrInsertGlobal(extension_point_ptr_id, extension_point_ptr_type));
            ...
            /**
            * Copy the function.
            * We are going to rewrite the innards of function so that it calls the extension.
            * This method keeps the original implementation around.
            * 'original' must be null on entry and will be non null on exit.
            *
            * To be clear - 'original' is a copy of the original function, not the function.
            */
            ...
            *   void augmentum::<function.name>__reflect__(void* return_value, void* arg_values[]) {
            *       ReturnType* ret = return_value;
            *       ArgType0* arg0 = arg_values[0];
            *       ArgType1* arg1 = arg_values[1];
            *       ...
            *       ArgTypeN* argN = arg_values[N];
            *       *ret = augmentum::<function.name>__original__(arg0, arg1, ..., argN);
            *   }
            * If the return type is void then return_value should be nullptr (but we don't both to check)
            * and nothing will be done with the return value.  I.e. the last line above becomes:
            *       augmentum::<function.name>__original__(arg0, arg1, ..., argN);
            */
            void make_reflect() {
                ...
                for (int i = 0; i < function_type->getNumParams(); ++i) {
                    ...
                    auto arg_value_ptr_ptr_void = builder.CreateConstInBoundsGEP1_64(nullptr, arg_values_ptr_ptr_void, i, "arg" + std::to_string(i) + "PPV");

                    Value* arg_value_ptr;
                    Argument* arg = function.getArg(i);
                    if(arg->hasAttribute(Attribute::ByVal)) {
                        // if one of the arguments has a byval attribute, we do one pointer cast less
                        arg_value_ptr = builder.CreateBitCast(arg_value_ptr_ptr_void, param_type->getPointerTo(), "arg" + std::to_string(i) + "PT");
                    } else {
                        auto arg_value_ptr_ptr = builder.CreateBitCast(arg_value_ptr_ptr_void, param_type->getPointerTo()->getPointerTo(), "arg" + std::to_string(i) + "PPT");
                ...
                if (return_type == Type::getVoidTy(ctx)) {
                    ...
                    auto return_value_ptr = builder.CreateBitCast(return_value_ptr_void, return_type->getPointerTo(), "retPT");
            ...
            * When the extension point isn't extended, this pointer points to the clone of the original function.
            * When the extension point is extended, it points to a function which dispatches to the library.
            * This way the cost of using this system but only extending a couple of things is kept to a minimum.
            * The code for this function looks like:
            *   ReturnType augmentum::<function.name>__extended__(ArgType0 arg0, ArgType1 arg1, ..., ArgTypeN argN) {
            *       ReturnType ret;
            *       void* args[] = { &arg0, &arg1, ..., &argN };
            *       augmentum::FnExtensionPoint::eval(augmentum::<function.name>__extension_point__, &ret, args);
            *       return ret;
            *   }
            * If the return type is void, then the ret pointer is the nullptr.  
            *   void augmentum::<function.name>__extended__(ArgType0 arg0, ArgType1 arg1, ..., ArgTypeN argN) {
            *       void* args[] = { &arg0, &arg1, ..., &argN };
            *       augmentum::FnExtensionPoint::eval(augmentum::<function.name>__extension_point__, nullptr, args);
            *   }
            */
            void make_extended() {
                ...
                Value* ret_alloc = ret_void ? 
                    nullptr: 
                    builder.CreateAlloca(ret_type, nullptr, "ret_alloc");
                ...
                for (int i = 0; i < extended->arg_size(); ++i) {
                    ...
                    if (!arg->hasAttribute(Attribute::ByVal)) {
                        auto arg_alloc = builder.CreateAlloca(arg->getType(), nullptr, "arg_alloc" + std::to_string(i));
                ...
                for (int i = 0; i < extended->arg_size(); ++i) {
                    ...
                    auto arg_void_ptr_ptr = builder.CreateConstInBoundsGEP2_64(nullptr, args_alloc, 0, i, "argVoidPtrPtr" + std::to_string(i));

                    // we reference byvals directly from the function arguments
                    if (arg->hasAttribute(Attribute::ByVal)) {
                        auto arg_ptr = builder.CreateBitCast(arg_void_ptr_ptr, arg_type->getPointerTo(), "argPtrPtr" + std::to_string(i));
                        builder.CreateStore(arg, arg_ptr);
                    } else {
                        auto arg_alloc = arg_allocs[i];
                        builder.CreateStore(arg, arg_alloc); // <-- XXX crashes here
                        auto arg_ptr_ptr = builder.CreateBitCast(arg_void_ptr_ptr, arg_type->getPointerTo()->getPointerTo(), "argPtrPtr" + std::to_string(i));
                        builder.CreateStore(arg_alloc, arg_ptr_ptr);
                    }
                }

                // Make the call
                auto ret_void_ptr = ret_void ? 
                    ConstantPointerNull::get(void_ptr_type): 
                    builder.CreateBitCast(ret_alloc, void_ptr_type, "retVoidPtr");
                auto args_void_ptr_ptr = builder.CreateConstInBoundsGEP2_64(nullptr, args_alloc, 0, 0, "argVoidPtrPtr");
                auto eval = module.getOrInsertFunction(symbol_Internal__eval, 
                    void_type,                                        // return
                ...
                auto call = builder.CreateCall(eval.getFunctionType(), eval.getCallee(), {extension_point, ret_void_ptr, args_void_ptr_ptr});
            ...
            */
            void clear_function() {
                ...
                // These blocks aren't dead yet, but this code works nicely to delete them all anyway.
            ...
            * The function will have all its code removed, then replaced with something like this:
            *   ReturnType <function.name>(ArgType0 arg0, ArgType1 arg1, ..., ArgTypeN argN) {
            *       ReturnType (*fn)(ArgType0, ArgType1, ..., ArgTypeN) = augmentum::<function.name>__extension_point__.fn;
            *       return fn(arg0, arg1, ..., argN);
            *   }
            */
            ...
            Type* get_type_by_name_or_create(const char* type_name) {
                ...
                if (!t) t = StructType::create(ctx, type_name);
                return t;
            }
            ...
            Value* get_unknown_type_desc(Type* type, IRBuilder<>& builder) {
                ...
                if (module_name_global == nullptr) {
                    module_name_global = new GlobalVariable(module, module_name_data->getType(), true, GlobalValue::PrivateLinkage, module_name_data, module_name_global_name);
                }
                auto zero = ConstantInt::getSigned(Type::getInt32Ty(ctx), 0);
                auto module_name_access = ConstantExpr::getInBoundsGetElementPtr(module_name_data->getType(), module_name_global, ArrayRef<Constant*>({zero, zero}));
                ...
                if (unknown_name_global == nullptr) {
                    unknown_name_global = new GlobalVariable(module, unknown_name_data->getType(), true, GlobalValue::PrivateLinkage, unknown_name_data, unknown_name_global_name);
                }
                auto unknown_name_access = ConstantExpr::getInBoundsGetElementPtr(unknown_name_data->getType(), unknown_name_global, ArrayRef<Constant*>({zero, zero}));

                // get unknown type desc value
                auto get_unknown_type = module.getOrInsertFunction(
                    symbol_Internal__get_unknown_type,
                ...
                auto get_unknown_type_call = builder.CreateCall(
                    get_unknown_type.getFunctionType(),
                    get_unknown_type.getCallee(), 
            ...
            Value* get_base_type_desc(IRBuilder<>& builder, StringRef get_base_type_call_symbol) {
                ...
                auto get_base_type = module.getOrInsertFunction(
                    get_base_type_call_symbol, typeDesc_ptr_type
                );
                auto base_typeDesc_call = builder.CreateCall(
                    get_base_type.getFunctionType(), 
                    get_base_type.getCallee()
                );
             ...
             * Add internal method prototype to module if it does not exist yet.
             */
            Value* get_pointer_type_desc(PointerType* ptype, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                assert(ptype);
                ...
                auto get_ptr_typeDesc = module.getOrInsertFunction(
                    symbol_Internal__get_ptr_type, typeDesc_ptr_type, typeDesc_ptr_type
                );
                auto get_ptr_typeDesc_call = builder.CreateCall(
                    get_ptr_typeDesc.getFunctionType(), 
                    get_ptr_typeDesc.getCallee(),
                    {element_value}
                );
            ...
            Value* get_array_type_desc(ArrayType* atype, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                assert(atype);
                ...
                auto get_array_typeDesc = module.getOrInsertFunction(
                    symbol_Internal__get_array_type, typeDesc_ptr_type, typeDesc_ptr_type, Type::getInt64Ty(ctx)
                );
                auto get_array_typeDesc_call = builder.CreateCall(
                    get_array_typeDesc.getFunctionType(), 
                    get_array_typeDesc.getCallee(),
            ...
            Value* get_named_struct_type_desc(StructType* struct_type, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                    assert(struct_type);
                    ...
                    if (struct_name_global == nullptr) {
                        struct_name_global = new GlobalVariable(module, struct_name_data->getType(), true, GlobalValue::PrivateLinkage, struct_name_data, struct_name_global_name);
                    }
                    auto struct_name_access = ConstantExpr::getInBoundsGetElementPtr(struct_name_data->getType(), struct_name_global, ArrayRef<Constant*>({zero, zero}));


                    // get struct type desc value
                    auto get_forward_struct_type = module.getOrInsertFunction(
                        symbol_Internal__get_forward_struct_type,
                        typeDesc_ptr_type,                       // return type
                        Type::getInt8PtrTy(ctx),                 // arg0 char* module_name
                    ...
                    auto get_forward_struct_type_call = builder.CreateCall(
                        get_forward_struct_type.getFunctionType(),
                        get_forward_struct_type.getCallee(), 
                    ...
                    auto set_struct_elem_types = module.getOrInsertFunction(
                        ...
                        symbol_Internal__set_struct_elem_types, FunctionType::get(Type::getVoidTy(ctx), {typeDesc_ptr_type, Type::getInt64Ty(ctx)}, true)
                    );

                    auto set_struct_elem_types_call = builder.CreateCall(set_struct_elem_types.getFunctionType(), set_struct_elem_types.getCallee(), args);
                    set_struct_elem_types_call->setTailCall();

                    // TODO is this necessary now that we save to the type map already after calling get_forward_struct
                    return get_forward_struct_type_call;
            }

            Value* get_unnamed_struct_type_desc(StructType* struct_type, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                    assert(struct_type);
                    ...
                    auto get_anon_struct_type = module.getOrInsertFunction(
                        // TODO make size_t int64 architecture dependent
                        symbol_Internal__get_anon_struct_type, FunctionType::get(typeDesc_ptr_type, {Type::getInt64Ty(ctx)}, true)
                    );

                    auto get_anon_struct_type_call = builder.CreateCall(get_anon_struct_type.getFunctionType(), get_anon_struct_type.getCallee(), args);
             ...
             * Add internal method prototype to module if it does not exist yet.
             */
            Value* get_struct_type_desc(StructType* struct_type, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                assert(struct_type);
             ...
             * Add internal method prototype to module if it does not exist yet.
             */
            Value* get_function_type_desc(FunctionType* function_type, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                ...
                auto get_function_type = module.getOrInsertFunction(
                    // TODO make size_t int64 architecture dependent
                    symbol_Internal__get_function_type, FunctionType::get(typeDesc_ptr_type, {typeDesc_ptr_type, Type::getInt64Ty(ctx)}, true)
                );

                auto function_desc_type_call = builder.CreateCall(get_function_type.getFunctionType(), get_function_type.getCallee(), args);
             ...
             */
            Value* get_type_desc(Type* type, IRBuilder<>& builder, std::unordered_map<Type*, Value*>& type_map) {
                assert(type);
            ...
            */
            void make_init() {
                ...
                auto name_global = new GlobalVariable(module, name_data->getType(), true, GlobalValue::PrivateLinkage, name_data);
                auto name_access = ConstantExpr::getInBoundsGetElementPtr(name_data->getType(), name_global, ArrayRef<Constant*>({zero, zero}));
                ...
                auto create_extension_point = module.getOrInsertFunction(
                    symbol_Internal__create_extension_point,    // function name
                ...
                auto call = builder.CreateCall(
                    create_extension_point.getFunctionType(), 
                    create_extension_point.getCallee(), 
                    {module_name_access, name_access, function_type_desc, fn_ptr, original_erased, extended_erased, reflect}, // args
            ...
            private:
                ...
                */
                ...
                bool collect_function_stats(Module& module) {
                    if (record_stats) {
                        ...
                        for(Function& function: module.getFunctionList()) {
                            ...
                            // get decision information on whether we can and should instument this module and function
                ...
                std::string can_id_to_string(CanInstrumentID can_id) {
                    switch(can_id) {
                        case CAN_NA: return "NA";
                        case CAN_INSTRUMENT: return "instrument";
                        case CAN_NOT_DECL: return "not_decl";
                        case CAN_NOT_VARARGS: return "not_varargs";
                        default: return "NA";
                    }
                }
                ...
                void emit_IR(const Module& module, const std::string& outDir) const {
                    ...
                    if (std::filesystem::exists(outDirP)) {
                        ...
                        errs() << "ERROR: [augmentum] opening output stream to emit module IR code failed. Path not found: "
                               << outDirP << "\n";
                    }
                }
        };
        ...
        char Augmentum::ID = 0;
        static RegisterPass<Augmentum> X(
            "augmentum",
            "Augmentum Pass"
        );
        ...
        static RegisterStandardPasses Y(
            ...
            [](const PassManagerBuilder &builder, legacy::PassManagerBase &pass_manager) {
