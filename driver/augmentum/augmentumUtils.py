...
def load_evaluation_config(raw_config : Iterable[str]) -> \
...
def setup_working_directories(wd_run : Path, general_cfg : Dict[str, Any],
                              sysprog_cfg : Dict[str, Any]) -> Tuple[Path,Path,Path]:
    """
