...
from augmentum.type_descs import ArrayTypeDesc, FunctionTypeDesc, StructTypeDesc, i32_t, void_t, i8_t
...
class TestStructDefinitionGeneration(unittest.TestCase):
    ...
    def test_single_struct(self):
        my_struct_td = StructTypeDesc("mymod.cpp","MyStruct",False,False,i32_t,i32_t)
...
struct  __augmentum__struct_0 { // MyStruct
   ...
   int32_t e1 ;
        ...
        self.assertEqual(
            ...
            expected_code.strip(), "Generated code not as expected.")


    def test_dependent_struct(self):

        my_inner_struct_td = StructTypeDesc("mymod.cpp","MyInnerStruct",False,False,i32_t,i32_t)
        my_struct_td = StructTypeDesc("mymod.cpp","MyStruct",False,False,my_inner_struct_td,i32_t)
        fn_type = FunctionTypeDesc(void_t, my_struct_td)
